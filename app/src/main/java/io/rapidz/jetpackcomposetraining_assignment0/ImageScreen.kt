...
fun ImageScreen() {
    ConstraintLayout(
        ...
        Text(
            text = stringResource(id = R.string.hello_world_image),
            style = TextStyle(fontSize = font_size_30, color = HelloWorldColor),
            modifier = Modifier
                .constrainAs(text) {
        ...
        Image(
            ...
            modifier = Modifier
                ...
                .clickable {
                    Toast
                        .makeText(context, "Thanks for the rating!", Toast.LENGTH_SHORT)
                        .show()
                }
        )
